...
class MAV(Thread):
    ...
    def __init__(self,
      ...
      left_electrode,
      # The right electrode for 3this MAV.
      right_electrode,
      ...
      **kwargs):
        ...
        self._ft=fly_time_sec
        self._ct=charge_time_sec
        # Initialize the running parameter
        self.running=True
    ...
    def run(self):
      ...
      #while loop for monitoring the mav if it is running
        while( self.running):
            ...
            sleep(self._ft)
           #After flying state, then go to waiting state
            self._state = _MAV_STATES.Waiting
            #Check if the left electrode and  the right_electrode are true
